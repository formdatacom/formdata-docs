...
# Introduction to Form Descriptors syntax (`.fd`)

Form Descriptor is a text based syntax that allows creating forms easily using text editor. Instead of building forms by hand in HTML or a GUI editor, you just write text. 

## Why build forms this way

While drag and drop makes a pleasant UI, it has several drawbacks:
- **Accessibility** - it's not easy for everyone to work with, it's not mobile friendly, and it gets really hard with large forms where you have to drag while scrolling
